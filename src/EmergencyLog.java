...
/**
 * This should only be used by something that doesn't have access to normal
...
public class EmergencyLog {
	/**
	 * Activate debug* methods if -Demergencylogdebug=true is set on the JVM.
	 */
	public static final boolean EDEBUG = Boolean.getBoolean("emergencylogdebug");

	/**
	 * Set this to blank to send to System.err instead.
	 */
	public static final String EFILE = System.getProperty("emergencylog_file", "elog.txt");
	...
	private static void printPrefixed(final Class<?> clazz, final String method, final String prefix,
	...
	/**
	 * Print specified data to the emergency log if
	 * -Dcom.ibm.ws.logging.edebug=true.
	 *
	 * @param clazz   The class source.
	 * @param method  The method source.
	 * @param objects A list of objects to trace.
	...
	/**
	 * Print specified data with an Entry prefix to the emergency log if
	 * -Dcom.ibm.ws.logging.edebug=true.
	 *
	 * @param clazz   The class source.
	 * @param method  The method source.
	...
	/**
	 * Print specified data with an Exit prefix to the emergency log if
	 * -Dcom.ibm.ws.logging.edebug=true.
	 *
	 * @param clazz   The class source.
	 * @param method  The method source.
